...
def _latest_verdict(symbol: str, committee_root: Optional[Path] = None) -> str:
    ...
    try:
        root = committee_root or Path(__file__).resolve().parent.parent / "memory" / ".committee"
...
def run(dry_run: Optional[bool] = None) -> Dict[str, Any]:
    ...
    from jobs.event_watch import _holdings_snapshot, _load_user_context, _trigger_committee
